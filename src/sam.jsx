/*<div className='px-14 w-3/4 bg-white drop-shadow-md flex flex-col
    '>
...
<div className="w-full h-72 bg-gray-100 rounded-t-[2rem] flex flex-col overflow-y-scroll scrollbar-none"
>
  <div className="w-full h-20 px-6 py-5 flex flex-col gap-1 ">
    ...
    <div className="group flex items-center gap-2 ml-auto cursor-pointer">
      ...
      <button className=""><MdAdd className='text-gray-50'
      /></button>
      <div>
        <span>{n.price}</span>
        <button  className="bg-orange-100 rounded-lg font-extrabold">Remove</button>
      </div>
    </div>
    </div>
  </div>
  ...
  justify-evenly px-8 ">
    <div className="w-full flex items-center justify-between">
      ...
      <p className='text-black text-lg'>{n.price}</p>
    </div>
    <div className="w-full flex items-center justify-between">
    ...
    <div className="w-full flex items-center justify-between">
      ...
      <p className='text-black text-xl font-semibold'>{n.price}</p>
    </div>
